 ...
 * For example, `data/bots/MY_BOT/config/whatsApp-integration.json` will be used by MY_BOT, while `data/global/config/whatsApp-integration.json` will be used for all others
 */
