...
declare module 'botpress/sdk' {
  ...
  export namespace realtime {
     ...
     */
    export function sendPayload(payload: RealTimePayload): any
    /**
  ...
  export namespace http {
     ...
     */
    export function deleteShortLink(name: any): void
     ...
     */
    export function deleteRouterForBot(routerName: string): any
  ...
  export namespace events {
    ...
    export function removeMiddleware(middlewareName: any): void
  ...
  export namespace kvs {
     ...
     * @deprecated will be removed, use global or forBot
     */
    export function removeStorageKeysStartingWith(key: any): Promise<void>
  }
  ...
  export namespace cms {
    ...
    export function readFile(botId: any, fileName: any): Promise<Buffer>
